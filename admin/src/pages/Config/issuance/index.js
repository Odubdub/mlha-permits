...
export const getIssuanceConfig = (serviceCode, version) => {

    const config = issuanceConfigs.find(issuanceConfig => issuanceConfig.code === serviceCode && issuanceConfig.version == version)
    return config
}