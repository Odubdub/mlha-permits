...
export const AuthorityTitle = () => {
  ...
  return (
    <Box sx={{ marginTop: 2, mx: 2 }}>
            ...
            >
            <div>
                <Box sx={{display: 'flex', flexDirection: 'row', color: 'textColor', alignItems: 'center'}}>
                ...
                <Menu
                    ...
                    transformOrigin={{ vertical: 'top', horizontal: 'right' }}>
                        ...
                        { Authorities.map((dept)=>(
                            <MenuItem sx={{ color: authority.shortTitle === dept.shortTitle ? 'primary.main' : 'text.secondary' }} key={dept.shortTitle}  onClick={()=>selectAuthority(dept)} >
                                <dept.icon sx={{marginRight:2}}/>
                                <ListItemText primary={dept.shortTitle} primaryTypographyProps={{ variant: 'body2' }} />
                            </MenuItem>
                        ))
                        }
                </Menu>
