...
const CardDetails = ({
  ...
  const isValid = () => {
    if (
      validateEmail(email) &&
      !isNotValue(cvv) &&
      !isNotValue(expiryYear) &&
      !isNotValue(cardNumber) &&
      !isNotValue(expiryMonth)
    ) {
      return true;
    }
          ...
          <Stack alignSelf="center" justifyContent="start" width={'100%'} flex={1}>
            ...
            >
              <Stack direction="row" alignItems="center">
                ...
                <Typography ml={1}>ACCOUNTANT GENERAL</Typography>
              </Stack>
              <Stack direction="row" justifyContent="space-between">
                <Typography fontWeight="800" fontSize={24}>
                  {amountStr}
                </Typography>
                <Typography>{feeName}</Typography>
              </Stack>
            </Stack>
            <Stack px={4} mx={3}>
              <form onSubmit={handleSubmit}>
                <TextField
                  ...
                  required
                />
                <FormHelperText>Enter a valid card number</FormHelperText>
                ...
                <Stack direction="row">
                  ...
                  <Stack>
                    <TextField
                      ...
                      required
                    />
                    <FormHelperText>Card Verification Code</FormHelperText>
                  </Stack>
                </Stack>
                <br />
                <TextField
                  ...
                  required
                />
                <FormHelperText>Payment receipt will be sent to this email</FormHelperText>
                <Stack>
                  <Button
                    type="submit"
                    variant="contained"
