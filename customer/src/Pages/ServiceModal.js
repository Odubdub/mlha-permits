...
export const ServiceModal = ({ service={}, footer, open, onClose }) => {
  ...
  return (
    <Modal BackdropProps={{style: {backgroundColor: 'transparent', background: "#ffffffaa", backdropFilter:'blur(5px)'}}} open={open}>
      <Stack sx={{ width: '100vw', height: '100%' }} justifyContent="center" alignItems="center">
        <Grow in={open}>
          ...
          >
            <Grid container direction="row" height='100%'>
              <Grid item xs={12} sm={12} md={6} lg={6} height='100%' justifyContent='start'>
                <Stack alignItems='center' px={3}>
                  ...
                  <Stack alignSelf='start' mt={1} mb={2} width='100%' pb={2} sx={{bgcolor: '#ceeffc60', px: 1, py: 1, borderRadius: 1.5}}>
                    ...
                    <Row mx={1} desc="Physical Address" detail={'Block 8, Government Enclave, Khama Crescent'} />
                  ...
                  <Stack alignSelf='start' mt={1} mb={2} width='100%' pb={2} sx={{bgcolor: '#ceeffc60', px: 1, py: 1, borderRadius: 1.5}}>
                    ...
                    <Row mx={1} desc="Application Fee" center={true} detail={'P 100.00'} alignItems='center' detailFontWeight={800} detailFontSize={20}/>
                  </Stack>
                </Stack>
              </Grid>
              ...
              <Grid item xs={12} sm={12} md={6} lg={6} height='100%' bgcolor='#80808010'>
                <Stack alignItems='center' height='100%' width='100%'>
                  <Stack justifyContent='space-between' direction='row' alignItems='center' borderBottom='0.5px dashed #80808080' height={50} width='100%'>
                    <LoadingButton startIcon={<Iconify icon="ri:draft-fill" />} sx={{alignSelf: 'end', mx: 1, my: 0.9, color: 'primary.main', '&:hover':{bgcolor: 'primary.lighter'}}} onClick={onClose}>
                      Save as Draft
                    </LoadingButton>
                    <LoadingButton endIcon={<Iconify icon="mdi:close" />} sx={{alignSelf: 'end', mx: 1, my: 0.9, color: 'red', '&:hover':{bgcolor: '#ff000020'}}} onClick={onClose}>
                      Close Application
                    </LoadingButton>
                  </Stack>
                  {
                  ...
                  <Divider sx={{ml: 3}}/>
                  <Stack justifySelf='end' sx={{borderRadius: '0px 0px 10px 0px', p: 1, borderTop: '0.5px dashed #80808080'}} justifyContent='end' direction='row' width='100%' height={60} right={30} alignItems='center'>
            ...
            <Modal BackdropProps={{style: {backgroundColor: 'transparent', background: "#ffffffaa", backdropFilter:'blur(5px)'}}} open={showPayment}>
              <CardDetails amount={(service||{}).serviceFee || 0} onClose={handleClosePayment} onCompletePayment={handleCompletePayment} feeName={(service||{}).feeName}/>
            </Modal>

            <Modal BackdropProps={{style: {backgroundColor: 'transparent', background: "#ffffffaa", backdropFilter:'blur(5px)'}}} open={showPaymentOptions}>
              <PaymentOptions onPicked={handleProceedToPayment} onClose={handleClosePaymentOptions}/>
            </Modal>
          </Stack>
        </Grow>
      </Stack>
