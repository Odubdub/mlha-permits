  ...
  return (
    <Box bgcolor="#fff" borderRadius={2} py={2} px={3}>
          ...
          <>
            {data.message != null && Object.keys(data.data).length == 0 ? (
              ...
              <List>
                ...
                />
                <Row desc="Person Status" type={WidgetType.chip} detail={data.PERSON_STATUS} />
                ...
                <Row title="Residence" type={WidgetType.devider} altDetColor={'blue'} />
      ...
      <Stack direction="row" height={35} justifyContent="start" alignItems="center" pb={1}>
        <img style={{ height: 35, marginTop: 20, objectFit: 'contain' }} src={omang} alt="" />
